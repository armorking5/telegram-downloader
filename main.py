...
parser.add_argument("-u","--user",dest="user", help="Username of the chats from where to begin to download files, by default will be used the logged username", default='')
parser.add_argument("-p", "--path", dest="exec_path", help="executible path of telegram-cli if is not on PATH", default='')
